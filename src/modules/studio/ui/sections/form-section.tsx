...
import { CopyCheckIcon, CopyIcon, Globe2Icon, ImagePlusIcon, LockIcon, MoreVerticalIcon, RotateCcwIcon, SparkleIcon, SparklesIcon, TrashIcon } from "lucide-react";
                                        ...
                                        <div className="flex flex-col gap-y-1">
                                            ...
                                            <div className="flex items-center gap-x-s">
                                                <Link href={`/videos/${video.id}`}>
                                                    <p className="link-clamp-1 text-sm text-blue-500">
                                                        {fullUrl}
                                                    </p>
                                                </Link>
                                                <Button
